...
<template>
  ...
  <div class="fkb-grid" :class="{ 'fkb-grid-6': showStandardsCard }">
    ...
    <div class="fkb-card" style="--accent:#1D9E75; --d:0ms;">
    ...
    <div class="fkb-card" style="--accent:#7F77DD; --d:80ms;">
    ...
    <!-- 3. EBITDA -->
    <div class="fkb-card" style="--accent:#EF9F27; --d:160ms;">
    ...
    <!-- 4. Чистая маржа -->
    <div class="fkb-card" style="--accent:#378ADD; --d:240ms;">
    ...
    <!-- 5. Убыточные -->
    <div class="fkb-card" style="--accent:#E24B4A; --d:320ms;">
    ...
    <div v-if="showStandardsCard" class="fkb-card" style="--accent:#534AB7; --d:400ms;">
