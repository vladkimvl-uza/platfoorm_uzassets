...
.dp-table th { background: #FAFAFC; text-align: left; padding: 9px 12px; font-size: 10.5px; font-weight: 500; letter-spacing: 0.04em; text-transform: uppercase; color: #888780; border-bottom: 0.5px solid #F1EFE8; }
.dp-table td { padding: 9px 12px; border-bottom: 0.5px solid #F4F4F2; color: #1E2A4A; vertical-align: top; }
