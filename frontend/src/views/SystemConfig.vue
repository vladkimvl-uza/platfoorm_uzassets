...
.sc-modal { position: relative; background: var(--card-bg, rgba(255,255,255,0.86)); backdrop-filter: blur(20px) saturate(1.4); -webkit-backdrop-filter: blur(20px) saturate(1.4); border: 1px solid var(--card-border, transparent); border-radius: 14px; box-shadow: 0 24px 64px rgba(15, 23, 60, 0.22), 0 8px 24px rgba(15, 23, 60, 0.10); padding: 22px 24px; width: 100%; max-width: 480px; animation: scModalIn .35s cubic-bezier(0.34, 1.2, 0.64, 1) .05s both; max-height: 90vh; overflow-y: auto; }
