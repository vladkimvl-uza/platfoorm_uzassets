...
get('/api-keys/catalog', 'GET /api-keys/catalog')
get('/api-keys/service-accounts', 'GET /api-keys/service-accounts')
get('/api-keys', 'GET /api-keys')
get('/api-keys?include_revoked=false', '/api-keys?include_revoked=false')
