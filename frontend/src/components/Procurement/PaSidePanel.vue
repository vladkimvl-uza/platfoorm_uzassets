    ...
    <div v-if="selectedCo" class="pa-radar-wrap">
      ...
      <div class="pa-mini-grid">
        ...
        <div class="pa-mini-kpi">
          ...
          <div class="pa-mini-v">{{ paFmtMoneyShort(Math.max(0, selectedCo.sum_dev)) }}<small>сум</small></div>
        </div>
        <div class="pa-mini-kpi">
          <div class="pa-mini-l">Категорий &gt; рынка</div>
          <div class="pa-mini-v">{{ selectedCo.above_count }}<small>из {{ selectedCo.cat_count }}</small></div>
        </div>
        <div class="pa-mini-kpi">
