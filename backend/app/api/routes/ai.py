...
async def ai_kpi_analysis(
    ...
    _persona = {
        ...
        "forecast": (
            ...
            "1) ПРОГНОЗ СУЩЕСТВУЮЩИХ KPI — ОБЯЗАТЕЛЬНО ТАБЛИЦЕЙ со столбцами: "
            ...
            "[low…high] модели. Разделяй прогноз по кварталам (остаток года) и по будущим годам.\n"
            "2) НОВЫЕ KPI — ОБЯЗАТЕЛЬНО ТАБЛИЦЕЙ со столбцами: Новый KPI | Определение | "
