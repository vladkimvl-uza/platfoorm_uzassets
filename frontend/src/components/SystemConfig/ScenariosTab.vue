...
<style scoped>
.st-wrap { font-family: inherit; color: var(--t1, #1E2A4A); }
.st-hdr { display: flex; justify-content: space-between; align-items: flex-end; gap: 22px; flex-wrap: wrap; margin-bottom: 20px; }
.st-eyebrow { font-size: 10.5px; font-weight: 500; color: var(--t3, var(--t-muted)); text-transform: uppercase; letter-spacing: .08em; display: flex; align-items: center; gap: 2px; }
.st-title { font-size: 22px; font-weight: 500; letter-spacing: -.02em; margin: 4px 0 6px; color: var(--t1, #1E2A4A); display: flex; align-items: center; gap: 4px; }
.st-sub { font-size: 12px; color: var(--t3, #5F5E5A); line-height: 1.55; max-width: 680px; margin: 0; }

.st-alert { padding: 10px 14px; border-radius: 8px; font-size: 12px; margin-bottom: 14px; }
.st-alert-bad  { background: rgba(226, 75, 74, .08); color: var(--sev-critical); border: 1px solid rgba(226, 75, 74, .18); }
.st-alert-good { background: rgba(29, 158, 117, .08); color: #0F6E56; border: 1px solid rgba(29, 158, 117, .18); }
.st-alert-info { background: rgba(127, 119, 221, .07); color: var(--p-deep); border: 1px solid rgba(127, 119, 221, .18); }
...
.st-loading { text-align: center; color: var(--t3, var(--t-muted)); padding: 40px; font-size: 12px; }
.st-empty { text-align: center; color: var(--t3, var(--t-muted)); padding: 60px 20px; background: var(--bg2, #FAFAFC); border-radius: 12px; font-size: 12.5px; }

.st-sec-l { font-size: 10px; color: var(--t3, var(--t-muted)); text-transform: uppercase; letter-spacing: .07em; font-weight: 500; margin: 20px 0 10px; display: flex; justify-content: space-between; align-items: center; gap: 8px; }
...
.st-sc { position: relative; padding: 12px 14px 14px; background: var(--bg1, #fff); border: 1px solid rgba(0,0,0,.06); border-radius: 9px; cursor: pointer; transition: all .14s; overflow: hidden; text-align: left; font-family: inherit; box-shadow: 0 1px 3px rgba(15, 23, 60, .03); display: flex; flex-direction: column; gap: 4px; min-height: 95px; }
...
.st-sc-l { font-size: 9.5px; color: var(--t3, var(--t-muted)); font-weight: 500; text-transform: uppercase; letter-spacing: .07em; }
.st-sc-n { font-size: 14px; font-weight: 500; color: var(--t1, #1E2A4A); letter-spacing: -.005em; line-height: 1.25; }
.st-sc-d { font-size: 11px; color: var(--t3, #5F5E5A); line-height: 1.45; }
.st-sc-overrides { font-size: 10px; color: var(--t3, var(--t-muted)); margin-top: auto; padding-top: 4px; }

/* Active scenario block */
.st-active { display: flex; justify-content: space-between; align-items: flex-start; gap: 14px; padding: 14px 16px; background: var(--bg2, #FAFAFC); border-radius: 10px; margin-top: 8px; }
.st-active-meta { flex: 1; min-width: 0; }
.st-active-eyebrow { font-size: 9.5px; color: var(--t3, var(--t-muted)); font-weight: 500; text-transform: uppercase; letter-spacing: .07em; margin-bottom: 4px; }
.st-active-name { display: flex; align-items: center; gap: 8px; font-size: 15px; font-weight: 500; color: var(--t1, #1E2A4A); letter-spacing: -.005em; }
.st-active-dot { width: 10px; height: 10px; border-radius: 50%; flex-shrink: 0; }
.st-active-code { font-family: ui-monospace, monospace; font-size: 10.5px; color: var(--t3, var(--t-muted)); background: rgba(15, 23, 60, .06); padding: 2px 7px; border-radius: 4px; font-weight: 400; }
.st-active-desc { font-size: 11.5px; color: var(--t3, #5F5E5A); line-height: 1.55; margin-top: 6px; max-width: 620px; }
.st-active-actions { display: flex; align-items: center; gap: 8px; flex-shrink: 0; }
.st-active-locked { font-size: 11px; color: var(--t3, var(--t-muted)); display: flex; align-items: center; gap: 4px; }

/* Table */
.st-tbl { width: 100%; border-collapse: separate; border-spacing: 0; background: var(--bg1, #fff); border-radius: 12px; box-shadow: 0 4px 14px rgba(15, 23, 60, 0.06); overflow: hidden; margin-top: 4px; }
.st-th { text-align: left; padding: 11px 10px; font-size: 10.5px; font-weight: 500; color: var(--t3, var(--t-muted)); text-transform: uppercase; letter-spacing: .07em; background: var(--bg2, #FAFAFC); border-bottom: 1px solid rgba(0, 0, 0, .05); vertical-align: top; }
...
.st-td-year { font-weight: 500; color: var(--t1, #1E2A4A); font-feature-settings: "tnum"; display: flex; align-items: center; gap: 6px; padding: 9px 10px; }
.st-td-actions { white-space: nowrap; }
.st-chip { font-size: 8.5px; color: var(--p-deep); background: rgba(127, 119, 221, .12); padding: 2px 6px; border-radius: 999px; font-weight: 500; text-transform: uppercase; letter-spacing: .04em; }

.st-row-dirty { background: rgba(239, 159, 39, .035); }
.st-row-dirty .st-td { border-color: rgba(239, 159, 39, .15); }

.st-input { font: inherit; font-size: 11.5px; padding: 5px 8px; border: 1px solid rgba(0, 0, 0, .12); border-radius: 5px; background: var(--bg1, #fff); color: var(--t1, #1E2A4A); width: 100%; min-width: 60px; max-width: 110px; font-feature-settings: "tnum"; transition: border-color .12s, background-color .14s; }
.st-input:focus { outline: none; border-color: #7F77DD; box-shadow: 0 0 0 2px rgba(127, 119, 221, .15); }
.st-input:disabled { background: var(--bg2, #FAFAFC); color: var(--t3, var(--t-muted)); cursor: not-allowed; }
...
.st-btn-g { background: var(--bg1, #fff); color: var(--t3, #5F5E5A); border-color: rgba(0, 0, 0, .12); }
.st-btn-g:hover:not(:disabled) { background: #F5F4F9; color: var(--t1, #1E2A4A); }
.st-btn-d { background: var(--bg1, #fff); color: var(--t3, var(--t-muted)); border-color: rgba(0, 0, 0, .12); }
.st-btn-d:hover:not(:disabled) { background: rgba(226, 75, 74, .08); color: var(--sev-critical); border-color: rgba(226, 75, 74, .25); }
...
.st-foot-card { display: flex; gap: 11px; padding: 12px 14px; background: var(--bg2, #FAFAFC); border-radius: 9px; font-size: 11.5px; color: var(--t3, #5F5E5A); line-height: 1.55; }
...
.st-foot-card strong { color: var(--t1, #1E2A4A); font-weight: 500; }
.st-foot-card em { font-style: italic; color: var(--p-deep); font-weight: 400; }
.st-foot-bottom { margin-top: 12px; padding: 11px 14px; font-size: 10.5px; color: var(--t3, var(--t-muted)); background: rgba(127, 119, 221, .04); border-radius: 8px; line-height: 1.55; }
...
.st-modal { position: relative; background: var(--card-bg, rgba(255,255,255,0.86)); border: 1px solid var(--card-border, transparent); border-radius: 14px; box-shadow: 0 24px 64px rgba(15, 23, 60, 0.22), 0 8px 24px rgba(15, 23, 60, 0.10); padding: 22px 24px; width: 100%; max-width: 480px; animation: stModalIn .35s var(--ease-standard) .05s both; max-height: 90dvh; overflow-y: auto; }
.st-modal-sm { max-width: 420px; }
.st-modal-x { position: absolute; top: 12px; right: 12px; width: 26px; height: 26px; border-radius: 7px; display: flex; align-items: center; justify-content: center; color: var(--t3, var(--t-muted)); background: var(--bg1, #fff); border: 1px solid rgba(0, 0, 0, .08); cursor: pointer; }
.st-modal-h { font-size: 16px; font-weight: 500; margin: 0 0 14px; color: var(--t1, #1E2A4A); }
.st-modal-text { font-size: 12.5px; color: var(--t3, #5F5E5A); line-height: 1.55; margin: 0 0 18px; }
.st-form { display: flex; flex-direction: column; gap: 12px; margin-bottom: 18px; }
.st-fld { display: flex; flex-direction: column; gap: 4px; }
.st-fld-l { font-size: 11px; color: var(--t3, var(--t-muted)); font-weight: 500; text-transform: uppercase; letter-spacing: .05em; display: flex; align-items: center; gap: 2px; }
