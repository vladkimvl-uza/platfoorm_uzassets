...
<template>
  <div class="nb-wrap">
    <button ref="bellEl" class="nb-bell" :class="{ active: isOpen, 'has-critical': store.criticalCount > 0 }" @click="toggle" :title="t('{value0} непрочитанных', { value0: store.unreadCount })">
