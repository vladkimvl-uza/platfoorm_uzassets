...
ROLE_PERMISSIONS: dict[str, list[str]] = {
    ...
    "organization": [
        ...
        # Workspace: org users edit all company indicators (scope still limits
        # WHICH companies via groups + allowed_sectors).
        "ratings.view", "ratings.edit", "ratings.import",
        "esg.view", "esg.edit", "esg.import",
        "financials.view", "financials.edit", "financials.import",
        "kpi.view", "kpi.edit", "kpi.import",
        "bp.view", "bp.edit", "bp.submit",
        "procurement.request.view", "procurement.request.create",
        ...
        "treasury.view", "treasury.budget.edit",
        "reports.view",
