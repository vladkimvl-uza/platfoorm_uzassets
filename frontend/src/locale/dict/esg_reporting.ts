/** ESG — новые составные строки KPI-отчётности (разбивка разовый/регулярный/
 *  IFRS SDS). Ключ = русский исходник; отдельные лейблы уже переведены в др.
 *  словарях. uz = латиница, en = английский; uz-кириллица — транслитерацией. */
export const uz: Record<string, string> = {
  "ESG-отчётность": "ESG-hisobot",
