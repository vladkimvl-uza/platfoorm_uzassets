...
def test_too_short():
    from app.core.password import validate_password_policy, PasswordPolicyError
...
def test_check_password_history_blocks_recent():
    from app.core.password import hash_password, check_password_history, PasswordPolicyError
...
def test_check_password_history_allows_different():
    from app.core.password import hash_password, check_password_history
    h1 = hash_password("Q9k!#mB7vN$wL2pR")
