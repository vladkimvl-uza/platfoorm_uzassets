...
async def ai_kpi_analysis(
    ...
    _persona = {
        ...
        "forecast": (
            ...
            "1) ПРОГНОЗ СУЩЕСТВУЮЩИХ KPI — оформи ОБЯЗАТЕЛЬНО ТАБЛИЦЕЙ со столбцами: "
            "Показатель | Руководитель | Тек. факт | Прогноз (базовый) | Пессим. | Оптим. | "
            "Драйверы и риски. Опирайся на тренды план/факт, финансовую траекторию и отраслевые/"
            "макро-факторы (web).\n"
            "2) НОВЫЕ KPI — оформи ОБЯЗАТЕЛЬНО ТАБЛИЦЕЙ со столбцами: Новый KPI | Определение | "
            "Ед. | Направление | Целевое значение | Связь с финансовым результатом. Предложи 3-5 "
            "содержательных показателей, которых сейчас НЕТ, под специфику сектора/компании.\n"
            "Кратко прокомментируй ключевые прогнозы под таблицами. Используй web для отраслевых "
            "практик и макро-прогнозов."
        ),
    }
