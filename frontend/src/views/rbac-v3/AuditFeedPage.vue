...
/* Modals */
.aud-backdrop { position: fixed; inset: 0; background: rgba(15,18,40,.5); -webkit-backdrop-filter: blur(2px); backdrop-filter: blur(2px); display: grid; place-items: center; z-index: var(--z-modal, 9100); padding: 20px; }
.aud-modal { background: #fff; border-radius: 18px; width: min(640px, 100%); max-height: 86dvh; max-height: 86dvh; display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 20px 60px rgba(15,23,60,.3); }
