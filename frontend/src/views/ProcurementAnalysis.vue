...
.pa-seg-light button { color: #888780; }
.pa-seg-light button:hover { color: #1E2A4A; }
...
.pa-em-ico { width: 14px; text-align: center; color: #888780; font-weight: 600; }
...
.pa-card-s { font-size: 11px; color: #888780; font-weight: 500; }
