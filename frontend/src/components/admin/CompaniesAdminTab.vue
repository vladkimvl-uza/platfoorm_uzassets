...
<style scoped>
.ca-wrap { padding: 0; }
.ca-error { background: rgba(226,75,74,.08); color: var(--sev-critical); padding: 8px 14px; border-radius: 6px; margin-bottom: 10px; display: flex; justify-content: space-between; font-size: 12px; }
...
.ca-btn-ghost.active { background: rgba(127,119,221,.1); color: var(--p-deep); border-color: rgba(127,119,221,.3); }
.ca-btn-red { background: rgba(226,75,74,.12); color: var(--sev-critical); }

.ca-list { max-height: 560px; overflow-y: auto; }
.ca-empty { padding: 24px; text-align: center; color: var(--t3, var(--t-muted)); font-size: 11px; font-style: italic; }
.ca-empty-detail { padding: 80px 20px; text-align: center; color: var(--t3, var(--t-muted)); font-size: 12px; }
...
.ca-sub { font-size: 10px; color: var(--t3, var(--t-muted)); }
...
.ca-detail-sub { font-size: 11px; color: var(--t3, var(--t-muted)); margin-top: 2px; }
.ca-detail-sub code { font-family: monospace; color: var(--p-deep); }
...
.ca-subtabs button { background: transparent; border: 0; color: var(--t3, var(--t-muted)); padding: 5px 12px; border-radius: 6px; font-size: 11px; cursor: pointer; font-family: inherit; white-space: nowrap; }
.ca-subtabs button.active { background: rgba(127,119,221,.1); color: var(--p-deep); font-weight: 500; }
.ca-section { padding: 14px 18px; }
.ca-section-l { font-size: 9.5px; color: var(--t3, var(--t-muted)); text-transform: uppercase; letter-spacing: .07em; font-weight: 500; margin-bottom: 8px; }
...
.ca-f label { font-size: 9.5px; color: var(--t3, var(--t-muted)); text-transform: uppercase; letter-spacing: .06em; }
...
.ca-x { background: transparent; border: 0; color: var(--t3, var(--t-muted)); cursor: pointer; font-size: 14px; }
.ca-add-btn { background: transparent; border: 0.5px dashed rgba(0,0,0,.2); color: var(--t3, var(--t-muted)); padding: 5px 8px; border-radius: 6px; font-size: 11px; cursor: pointer; font-family: inherit; }
...
.ca-prev-sec { font-size: 10px; color: var(--t3, var(--t-muted)); }
...
.ca-year-label { font-size: 10.5px; color: var(--t3, var(--t-muted)); margin-bottom: 4px; font-weight: 500; }
...
.ca-switch input:checked + .ca-switch-tr { background: var(--green); }
...
.ca-chip.dimmed { background: rgba(0,0,0,.04); color: var(--t3, var(--t-muted)); cursor: pointer; }
...
.ca-hint { display: flex; align-items: center; gap: 6px; padding: 8px 10px; background: rgba(127,119,221,.06); color: var(--p-deep); border-radius: 6px; font-size: 11.5px; margin-bottom: 8px; }
...
.ca-inline-hint { font-size: 10px; color: var(--t3, var(--t-muted)); line-height: 1.4; }
