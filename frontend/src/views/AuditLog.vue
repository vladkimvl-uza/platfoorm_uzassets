...
.au-live { margin-left: 8px; color: #1D9E75; }
.au-live-dot {
  display: inline-block; width: 6px; height: 6px; border-radius: 50%;
  background: #1D9E75; margin-right: 3px;
...
.au-clear {
  ...
  color: #534AB7; font-size: 11px; padding: 5px 10px;
  border-radius: 7px; cursor: pointer; font-weight: 500;
}

.au-error { padding: 16px 22px; color: #A32D2D; font-size: 12px; }
...
.au-delta.up { color: #1D9E75; }
.au-delta.down { color: #E24B4A; }
...
.au-feed-code.ok { color: #1D9E75; }
.au-feed-code.bad { color: #A32D2D; font-weight: 500; }
...
.au-kv-v .role {
  ...
  background: rgba(127,119,221,.1); color: #534AB7;
  padding: 2px 6px; border-radius: 4px;
}
.au-jsbox {
