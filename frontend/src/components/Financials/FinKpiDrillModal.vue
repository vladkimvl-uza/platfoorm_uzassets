...
.ddm-card { position: relative; background: var(--card-bg, rgba(255, 255, 255, 0.86)); backdrop-filter: blur(20px) saturate(1.4); -webkit-backdrop-filter: blur(20px) saturate(1.4); border: 1px solid var(--card-border, transparent); border-radius: 14px; box-shadow: 0 24px 64px rgba(15, 23, 60, 0.22), 0 8px 24px rgba(15, 23, 60, 0.10); width: 100%; max-width: 860px; overflow: hidden; animation: ddmIn .55s cubic-bezier(0.34, 1.2, 0.64, 1) .08s both; }
...
.ddm-l-sec { font-size: 10px; color: var(--t3, #888780); text-transform: uppercase; letter-spacing: .07em; font-weight: 500; margin-bottom: 8px; display: flex; justify-content: space-between; align-items: center; gap: 12px; }
...
.ddm-fltr-chip { padding: 2px 8px; border-radius: 999px; font-size: 10px; letter-spacing: 0; text-transform: none; cursor: pointer; font-weight: 500; color: var(--t3, #888780); background: transparent; transition: all .14s; }
...
.ddm-trend-year { font-size: 9px; color: var(--t3, #888780); }
