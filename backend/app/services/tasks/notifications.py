...
async def notify_task_assignment(
    ...
    *,
    ...
    await notify(
        ...
        body=body,
        title_template="Задача назначена: {title}",
        template_vars={"title": task.title},
        source_module="tasks",
    ...
    *,
    ...
    for uid in recipients:
        await notify(
            ...
            title_template="Статус задачи: {title}",
            body_template="{actor} · {old_status} → {new_status}",
            template_vars={
                "title": task.title,
                "actor": actor_name,
                "old_status": old_lbl,
            ...
            translate_vars={"old_status", "new_status"},
            priority="normal",
            source_module="tasks",
            source_entity_id=str(task.id),
            source_user_id=actor.id,
