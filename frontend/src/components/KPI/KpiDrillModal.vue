...
function srcShort(s?: string | null): string {
  return ({
    ytd: t("Σ кв."), ytd_q4: t("нараст."), nsbu: t("НСБУ"), bp_plan: t("БП"), bp: t("БП"),
    quarter_cum: t("нараст."),
...
function srcTitle(s?: string | null): string {
  return ({
    ...
    ytd: t("Годовой факт не закрыт: сумма Q1..Q4 (кварталы строки — суммы за квартал)"),
    ytd_q4: t("Годовой факт не закрыт: последний закрытый квартал (кварталы строки ведутся нарастающим итогом)"),
    quarter_cum: t("Значение с начала года на конец квартала (кварталы строки ведутся нарастающим итогом)"),
    nsbu: t("Факт из НСБУ-отчётности (связь с Бизнес-планом)"),
    bp_plan: t("План из Бизнес-плана (связанный KPI)"),
    bp: t("Из Бизнес-плана (связанный KPI)"),
  } as Record<string, string>)[s || ""] || "";
}
