...
.mp-eyebrow { font-size: 10.5px; letter-spacing: 0.08em; text-transform: uppercase; color: var(--t3, var(--t-muted)); font-weight: 500; }
...
.mp-sub { font-size: 12.5px; color: var(--t3, var(--t-muted)); margin-top: 4px; }

.mp-list { display: flex; flex-direction: column; gap: 8px; }
.mp-loading, .mp-empty { padding: 32px; text-align: center; color: var(--t3, var(--t-muted)); font-size: 13px; }
</style>
