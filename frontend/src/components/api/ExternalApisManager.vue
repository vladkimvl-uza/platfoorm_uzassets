...
.xa-modal { background: var(--color-background-primary); width: 100%; max-width: 480px; border-radius: 12px; overflow: hidden; box-shadow: 0 24px 64px rgba(15,23,60,.18); animation: xaIn .35s cubic-bezier(.34,1.2,.64,1); }
