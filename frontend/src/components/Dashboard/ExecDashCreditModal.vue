...
.ecm-overlay { position:fixed; inset:0; background:rgba(15,18,40,.45); -webkit-backdrop-filter: blur(8px); backdrop-filter:blur(8px); display:flex; align-items:flex-start; justify-content:center; padding:48px 24px; z-index:1000; animation:ecmBgIn .25s ease both; overflow-y:auto; }
.ecm { background: var(--bg1, #fff); border:1px solid var(--card-border, transparent); border-radius:14px; box-shadow:0 24px 64px rgba(15,23,60,.22), 0 8px 24px rgba(15,23,60,.10); width:100%; max-width:880px; overflow:hidden; animation:ecmIn .45s var(--ease-standard) both; }
...
.ecm-hdr-eyebrow { font-size:9.5px; color: var(--t3, var(--t-muted)); text-transform:uppercase; letter-spacing:.07em; font-weight:500; }
.ecm-hdr-title { font-size:16px; font-weight:500; color: var(--t1, #1E2A4A); letter-spacing:-.005em; margin:3px 0 4px; }
.ecm-x { width:28px; height:28px; border-radius:50%; background: var(--bg2, #FAFAFC); border:1px solid rgba(0,0,0,.08); display:flex; align-items:center; justify-content:center; cursor:pointer; color: var(--t3, var(--t-muted)); flex-shrink:0; }
...
.ecm-mmi-l { font-size:8.5px; font-weight:500; color: var(--t3, var(--t-muted)); text-transform:uppercase; letter-spacing:.05em; line-height:1.3; min-height:22px; }
...
.ecm-l { font-size:9.5px; color: var(--t3, var(--t-muted)); text-transform:uppercase; letter-spacing:.07em; font-weight:500; margin:14px 0 6px; }
...
.ecm-tbl th { font-size:8.5px; font-weight:500; color: var(--t3, var(--t-muted)); text-transform:uppercase; letter-spacing:.06em; padding:8px 8px; background: var(--bg2, #FAFAFC); text-align:left; border-bottom:1px solid rgba(0,0,0,.05); }
...
.ecm-cell-name small { display:block; font-size:9px; color: var(--t3, var(--t-muted)); margin-top:1px; font-weight:400; }
...
.ecm-tag-overdue { background:rgba(226,75,74,.10); color:var(--sev-critical); margin-left:3px; }
...
.ecm-mtt strong { color:var(--p-deep); font-weight:500; }
...
.ecm-foot-l { font-size:10px; color: var(--t3, var(--t-muted)); }
...
.ecm-btn-p:hover { background:var(--p-deep); }
</style>
