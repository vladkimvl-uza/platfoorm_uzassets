...
.ddm-card { position: relative; background: #fff; border-radius: 14px; box-shadow: 0 24px 64px rgba(15, 23, 60, 0.22), 0 8px 24px rgba(15, 23, 60, 0.10); width: 100%; max-width: 820px; overflow: hidden; animation: ddmIn .55s cubic-bezier(0.34, 1.2, 0.64, 1) .08s both; }
...
.ddm-l-sec { font-size: 10px; color: #888780; text-transform: uppercase; letter-spacing: .07em; font-weight: 500; margin-bottom: 8px; display: flex; justify-content: space-between; align-items: center; }
...
.ddm-co { border: 1px solid rgba(0, 0, 0, .05); border-radius: 9px; background: #fff; overflow: hidden; transition: all .14s; }
...
.ddm-co-chev { color: #888780; transition: transform .18s ease; display: flex; align-items: center; justify-content: center; }
.ddm-co.expanded .ddm-co-chev { transform: rotate(90deg); color: #7F77DD; }
.ddm-co-tick { width: 3px; height: 14px; border-radius: 1px; }
.ddm-co-name { color: #1E2A4A; font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; cursor: pointer; border-bottom: 1px dashed transparent; transition: color .14s ease, border-color .14s ease; }
...
.ddm-co-stat-num { color: #1E2A4A; font-weight: 500; }
.ddm-co-stat-tot { color: #888780; }
...
.ddm-co-sub { font-size: 9.5px; color: #888780; text-transform: uppercase; letter-spacing: .06em; font-weight: 500; margin: 10px 0 6px; display: flex; justify-content: space-between; align-items: center; }
...
.ddm-loading { padding: 30px 20px; text-align: center; color: #888780; font-size: 12px; }
