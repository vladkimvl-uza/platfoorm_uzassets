...
.txd-x:hover { background: #FAFAFC; color: #1E2A4A; }
...
.txd-h-l { font-size: 10.5px; font-weight: 500; color: #888780; text-transform: uppercase; letter-spacing: .08em; }
.txd-h-v { font-size: 44px; font-weight: 500; letter-spacing: -.035em; line-height: 1; color: #1E2A4A; font-feature-settings: "tnum"; margin-top: 6px; display: flex; align-items: baseline; gap: 8px; flex-wrap: wrap; }
.txd-h-v .unit { font-size: 13px; color: #888780; font-weight: 500; letter-spacing: 0; }
...
.txd-h-tag-list { margin-top: 10px; font-size: 11px; color: #888780; font-weight: 500; }
...
.txd-l-sec { font-size: 10px; color: #888780; text-transform: uppercase; letter-spacing: .07em; font-weight: 500; margin-bottom: 8px; display: flex; justify-content: space-between; align-items: center; }
...
.txd-leg-pct { color: #888780; margin-left: 6px; font-feature-settings: "tnum"; }
...
.txd-empty { padding: 16px; text-align: center; color: #888780; font-size: 11.5px; font-style: italic; }

.txd-ftr { padding: 13px 22px 14px; display: flex; justify-content: flex-end; gap: 9px; border-top: 1px solid rgba(0, 0, 0, 0.05); background: #FAFAFC; margin-top: 4px; }
...
.txd-btn-g { background: #fff; color: #5F5E5A; border-color: rgba(0, 0, 0, 0.10); }
.txd-btn-g:hover { background: #F5F4F9; color: #1E2A4A; }
